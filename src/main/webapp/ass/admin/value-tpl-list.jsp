...
<q:js src="value-tpl-list" />
</head>
<body>
	<%@include file="common.jsp"%>
	<form action="value-tpl-list.action" method="post">
		<jsp:include page="tpl-list-body.jsp" />
		${assAdmin.valueTplsTable}
		...
		<div id="input">
			...
			<table>
				...
				<tr>
					<td>备注</td>
					<td><textarea id="iOther" name="iOther" rows="8" cols="80"></textarea></td>
				</tr>
				<tr>
